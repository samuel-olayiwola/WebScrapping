...
def createNewDir(struct,num):
    path = os.path.join(type_exam,subject,struct,str(year),str(num))
...
def convertToJson(data):
     filename = "output_" + type_exam + "_" + str(month) + "_" + str(year) + "_"  + subject + ".json"
...
if __name__ == '__main__':
    try :
        ...
        parser.add_argument("examType",type=str,help="Exam type")
        parser.add_argument("subject",type=str,help="subject name")
        parser.add_argument("year",type=str,help="Exam year")
        args = parser.parse_args()
    except argparse.ArgumentError:
        print(argparse.ArgumentError.message())


    subject = "English Language"
    type_exam = "NECO"
    month = "MAR"
    years = [2001,2002,2003,2004,2005,2008,2009]
    session = HTMLSession()
    for i in years:
         house.clear()
         year = i
         base_url = "https://nigerianscholars.com/past-questions/english-language/neco/year/" + str(i)
         cookSoup(base_url,session)

##    house.clear()
##    year = 2009
##    base_url = "https://nigerianscholars.com/past-questions/economics/neco/year/2009"
##    cookSoup(base_url,session)
##    
